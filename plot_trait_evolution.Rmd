...
Skulls are organised from **largest** to **smallest**. The largest skulls are **vulture-like**, (e.g. **no. 100, the Andean condor** [*Vultur gryphus*](https://en.wikipedia.org/wiki/Andean_condor)) and the  smallest are **falconet-like**, (e.g. **no. 1 Collared falconet** [*Microhierax caerulescens*](https://en.wikipedia.org/wiki/Collared_falconet))
...
breaks <- seq(-max.x, max.x, length.out = 101)
