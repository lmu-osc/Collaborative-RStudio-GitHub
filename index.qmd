...
* [Fork](fork.qmd) - Copy your collaborator's repository 
* [Clone](clone.qmd) - Copy your repository locally
* [Commit](commit.qmd) - Make changes and save them locally
* [Push](push.qmd) - Update your remote repository with your local changes
* [Pull request](pull-request.qmd) - Ask your collaborator to integrate your changes in their repository
* [Merged results](merge.qmd) - Observe the merge of all contributions
* [Pull the upstream repository into your fork](pull-upstream.qmd) - Update your fork with all contributions made to the original repository
